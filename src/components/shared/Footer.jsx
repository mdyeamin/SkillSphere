      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="col-span-1 md:col-span-2 space-y-5">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex flex-col gap-2.5">
                <a
                  href="mailto:info@skillsphere.com"
                  className="flex items-center gap-2 text-sm text-gray-500 hover:text-[#914C00] transition-colors"
                >
        ...
        <div className="border-t border-gray-100 py-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <p className="text-xs text-gray-400 text-center sm:text-left order-2 sm:order-1">
            © {new Date().getFullYear()} SkillSphere Academy. All rights
            reserved.
          </p>
          ...
          <div className="flex items-center gap-5 order-1 sm:order-2">
            ...
            <Link
              href="#"
              aria-label="Website"
              className="text-gray-400 hover:text-[#914C00] transition-colors border-l pl-5 ml-2 border-gray-200"
            >
