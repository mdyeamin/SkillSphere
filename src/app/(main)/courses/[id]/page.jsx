          ...
          <section>
            ...
            <div className="border border-gray-200 rounded-xl p-6 flex flex-col md:flex-row gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[#914c00] font-bold text-sm">
                  {instructor.position}
                </p>
          ...
          <section>
            <div className="flex justify-between items-end mb-6">
              ...
              <span className="text-xs text-gray-500 font-medium">
                32 sections • 482 lectures • 52h 14m total length
              </span>
            </div>
                ...
                <div className="p-2 bg-white">
                  <div className="flex justify-between items-center p-3 text-sm hover:bg-gray-50 rounded">
                    <div className="flex items-center gap-3">
                      <BsPlayCircle className="text-gray-400" /> Welcome to the
                      Course!
                    </div>
                    <span className="text-[#a435f0] font-bold cursor-pointer underline">
                      Preview
                    </span>
                  </div>
                  <div className="flex justify-between items-center p-3 text-sm hover:bg-gray-50 rounded">
                    <div className="flex items-center gap-3">
                      <BsPlayCircleFill className="text-gray-400" /> How the Web
                      Works
                    </div>
              ...
              {[2, 3].map((num) => (
                ...
                >
                  <div className="flex items-center gap-3 font-bold text-sm text-gray-500">
                    <LuLock className="text-gray-400" /> Section {num}:{" "}
                    {num === 2
          ...
          <div className="lg:absolute lg:-top-64 right-0 w-full lg:w-[350px] bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden z-30">
            ...
            <div className="p-6 space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="bg-[#f28e2b]/10 text-[#914c00] text-[10px] font-bold px-2 py-0.5 rounded">
                  50% OFF
                </span>
              </div>
              ...
              <div className="space-y-4 pt-4 border-t border-gray-100">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex items-center gap-4 text-xs text-gray-700"
                    >
